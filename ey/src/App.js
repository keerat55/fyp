...
import SalAdmin from './components/Admin/saladmin';
//import Assignmetamask from '.components/Admin/Assignmetamask';
//import Assign from '.components/Admin/Assign.js';

//import Assignmetamask from './components/Admin/Assignmetamask.js';
...
const App = () =>
{
  ...
  <Loading/> : (
    <Switch>
      ...
      <AdminRoute path='/saladmin'>
        <SalAdmin/>
      </AdminRoute>
      {/* <AdminRoute exact path='/Assignmetamask'>
        <Assignmetamask/>
      </AdminRoute> */}

{/* <AdminRoute exact path='/assign'>
        <Assign/>
      </AdminRoute> */}
    </Switch>
  )
