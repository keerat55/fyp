      ...
      <div className="table-responsive">
          <table className="table table-striped table-md center-text">
              ...
              {/* <tbody className="sidebar-wrapper">{
                ...
                <td>{idx+1}</td>  
                <td>
                  {employeeMap && employeeMap[application.applicantID] &&
        employeeMap[application.applicantID][0]}</td>
                <td>{employeeMap && employeeMap[application.applicantID] &&
        employeeMap[application.applicantID][1]}</td>
                <td>{application.type}</td>
                <td>{application.title}</td>
                <td>{application.appliedDate}</td>
                <td className={
                  `${application.adminResponse==="Rejected"?"text-danger":application.adminResponse==="Pending"?"text-primary":"text-success"}`}>
...
<tbody className="sidebar-wrapper">
  {applications?.map((application, idx) => (
    ...
    >
      ...
      <td>
        {employeeMap &&
          employeeMap[application.applicantID] &&
          employeeMap[application.applicantID][0]}
      </td>
      <td>
        {employeeMap &&
          employeeMap[application.applicantID] &&
          employeeMap[application.applicantID][1]}
      </td>
      <td>{application.type}</td>
      <td>{application.title}</td>
      <td>{application.appliedDate}</td>
